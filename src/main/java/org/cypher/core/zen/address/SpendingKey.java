...
import org.cypher.common.zksnark.JLibsodium;
import org.cypher.common.zksnark.JLibsodiumParam;
...
public class SpendingKey {
  ...
  private static class PRF {
    public static final byte[] ZCYPHER_EXPANDSEED_PERSONALIZATION = {'Z', 't', 'r', 'o', 'n', '_',
        'E', 'x', 'p', 'a', 'n', 'd', 'S', 'e', 'e', 'd'};
    ...
    private static byte[] prfExpand(byte[] sk, byte t) throws ZksnarkException {
      ...
      try {
        JLibsodium.cryptoGenerichashBlake2bInitSaltPersonal(new JLibsodiumParam.Blake2bInitSaltPersonalParams(
            state, null, 0, 64, null, ZCYPHER_EXPANDSEED_PERSONALIZATION));

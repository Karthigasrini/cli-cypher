        ...
        while (end < blockNum) {
          ...
          if (notes.isPresent()) {
            ...
            for (int i = 0; i < notes.get().getNoteTxsList().size(); ++i) {
              ...
              noteInfo.setCypId(ByteArray.toHexString(noteTx.getTxid().toByteArray()));

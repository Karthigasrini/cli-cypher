...
import org.cypher.api.GrpcAPI.Note;
import org.cypher.api.GrpcAPI.PrivateShieldedTRC20Parameters;
import org.cypher.api.GrpcAPI.ReceiveNote;
import org.cypher.api.GrpcAPI.Return;
import org.cypher.api.GrpcAPI.SpendNoteTRC20;
...
import org.cypher.common.utils.Hash;
...
import org.cypher.protos.contract.SmartContractOuterClass;
import org.cypher.protos.contract.SmartContractOuterClass.TriggerSmartContract;
import org.cypher.walletserver.GrpcClient;
...
public class ShieldedTRC20Demo {
  ...
  private byte[] triggerGetScalingFactor(byte[] contractAddress) {
    ...
    GrpcAPI.TransactionExtention cypExt2 = grpcClient.triggerConstantContract(
        triggerBuilder.build());
    List<ByteString> list = cypExt2.getConstantResultList();

...
import org.cypher.common.utils.AbiUtil;
...
import org.cypher.common.zksnark.LibrustzcashParam;
import org.cypher.core.exception.CancelException;
import org.cypher.core.exception.CipherException;
import org.cypher.core.exception.EncodingException;
import org.cypher.core.exception.ZksnarkException;
import org.cypher.core.zen.ShieldedAddressInfo;
import org.cypher.core.zen.ShieldedNoteInfo;
import org.cypher.core.zen.ShieldedTRC20NoteInfo;
import org.cypher.core.zen.ShieldedTRC20Wrapper;
import org.cypher.core.zen.ShieldedWrapper;
import org.cypher.core.zen.ZenUtils;
import org.cypher.core.zen.address.DiversifierT;
import org.cypher.core.zen.address.ExpandedSpendingKey;
import org.cypher.core.zen.address.IncomingViewingKey;
import org.cypher.core.zen.address.KeyIo;
import org.cypher.core.zen.address.PaymentAddress;
import org.cypher.core.zen.address.SpendingKey;
import org.cypher.keystore.StringUtils;
...
import org.cypher.protos.Protocol.DelegatedResourceAccountIndex;
...
public class Client {
  ...
  private void assetIssue(String[] parameters)
    ...
    if (parameters == null || parameters.length < 12) {
      ...
      System.out.println("AssetIssue [OwnerAddress] AssetName AbbrName TotalSupply CypNum AssetNum Precision "
      ...
      System.out.println("CypNum and AssetNum represents the conversion ratio of the cypher to the asset.");
    ...
    String cypNumStr = parameters[index++];
    ...
    int cypNum = new Integer(cypNumStr);
    ...
    boolean result = walletApiWrapper.assetIssue(ownerAddress, name, abbrName, totalSupply,
        cypNum, icoNum, precision, startTime, endTime, 0,
  ...
  private void freezeBalance(String[] parameters)
    ...
    if (parameters == null || !(parameters.length == 2 || parameters.length == 3
      ...
      System.out.println("freezeBalance [OwnerAddress] frozen_balance frozen_duration "
          + "[ResourceCode:0 BANDWIDTH,1 ENERGY,2 CYPHER_POWER] [receiverAddress]");
      return;
    }
  ...
  private void unfreezeBalance(String[] parameters)
    ...
    if (parameters == null || parameters.length < 1 || parameters.length > 3) {
      ...
      System.out.println(
          "unfreezeBalance [OwnerAddress] ResourceCode(0 BANDWIDTH,1 ENERGY,2 CYPHER_POWER) [receiverAddress]");
      return;
    }
...
//  }
  ...
  private void deployContract(String[] parameter)
    ...
    if (parameters == null ||
      ...
      System.out.println(
          "DeployContract [ownerAddress] contractName ABI byteCode constructor params isHex fee_limit consume_user_resource_percent origin_energy_limit value token_value token_id(e.g: CYPTOKEN, use # if don't provided) <library:address,library:address,...> <lib_compiler_version(e.g:v5)>");
//      System.out.println(
//          "Note: Please append the param for constructor tightly with byteCode without any space");
  ...
  private void triggerContract(String[] parameters)
    ...
    if (parameters == null || (parameters.length != 8 && parameters.length != 9)) {
      ...
      System.out.println("TriggerContract [OwnerAddress] contractAddress method args isHex"
          + " fee_limit value token_value token_id(e.g: CYPTOKEN, use # if don't provided)");
      return;
    }
  ...
  private void triggerConstantContract(String[] parameters)
    ...
    if (parameters == null || (parameters.length != 5 && parameters.length != 8)) {
      ...
      System.out.println("TriggerConstantContract ownerAddress(use # if you own)"
          + " contractAddress method args isHex [value token_value token_id(e.g: CYPTOKEN, use # if don't provided)]");
      return;
    }
  ...
  private void listShieldedNote(String[] parameters) {
    ...
    if (showType == 0) {
      ...
      for (Entry<Long, ShieldedNoteInfo> entry : noteMap.entrySet()) {
        ...
        string += " ";
        string += entry.getValue().getCypId();
        string += " ";
  ...
  private void getSpendingKey() {
    while (true) {
      byte[] skBytes = org.cypher.keystore.Wallet.generateRandomBytes(32);
  ...
  private void help() {
    System.out.println("Help: List of Cypher Wallet-cli commands");
    System.out.println(
  ...
  private void run() {
    System.out.println(" ");
    System.out.println("Welcome to Cypher Wallet-Cli");

...
import org.cypher.core.zen.address.FullViewingKey;
...
import org.cypher.protos.contract.ShieldContract.OutputPoint;
...
//      System.out.println("Warning: GetAddress failed,  Please login first !!");
  ...
  public boolean assetIssue(byte[] ownerAddress, String name, String abbrName, long totalSupply,
    ...
    if (cypNum <= 0) {
      System.out.println("cypNum should greater than 0. but really is " + cypNum);
      return false;
    }
    builder.setCypNum(cypNum);
  ...
  public boolean sendShieldedCoin(String fromAddress, long fromAmount, List<Long> shieldedInputList,
    ...
    if (shieldedInputList.size() > 0) {
      ...
      for (int i = 0; i < shieldedInputList.size(); ++i) {
        ...
        outPointBuild.setHash(ByteString.copyFrom(ByteArray.fromHexString(noteInfo.getCypId())));
      ...
      for (int i = 0; i < shieldedInputList.size(); ++i) {
        ...
        System.out.println("cypId " + noteInfo.getCypId());

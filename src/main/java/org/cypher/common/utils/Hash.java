...
import static org.cypher.common.utils.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.cypher.common.utils.ByteUtil.isNullOrZeroArray;
import static org.cypher.common.utils.ByteUtil.isSingleZero;
...
public class Hash {
  ...
  static {
    Security.addProvider(CypherCastleProvider.getInstance());
    CRYPTO_PROVIDER = Security.getProvider("BC");
    HASH_256_ALGORITHM_NAME = "CYPHER-KECCAK-256";
    HASH_512_ALGORITHM_NAME = "CYPHER-KECCAK-512";

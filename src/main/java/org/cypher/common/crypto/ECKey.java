...
import org.cypher.common.crypto.cryptohash.Keccak256;
import org.cypher.common.crypto.jce.ECKeyAgreement;
import org.cypher.common.crypto.jce.ECKeyFactory;
import org.cypher.common.crypto.jce.ECKeyPairGenerator;
import org.cypher.common.crypto.jce.ECSignatureFactory;
import org.cypher.common.crypto.jce.CypherCastleProvider;
import org.cypher.common.utils.BIUtil;
...
public class ECKey implements Serializable, SignInterface {
  ...
  public ECKey(SecureRandom secureRandom) {
    this(CypherCastleProvider.getInstance(), secureRandom);
  }
  ...
  public ECKey(byte[] key, boolean isPrivateKey) {
    ...
    this.provider = CypherCastleProvider.getInstance();
  }
  ...
  public ECKey(@Nullable BigInteger priv, ECPoint pub) {
    this(CypherCastleProvider.getInstance(), privateKeyFromBigInteger(priv), pub);
  }
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory.getInstance(CypherCastleProvider.getInstance())

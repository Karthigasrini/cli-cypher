package org.cypher.walletserver;
...
import org.cypher.api.GrpcAPI.AccountNetMessage;
import org.cypher.api.GrpcAPI.AccountResourceMessage;
import org.cypher.api.GrpcAPI.AddressPrKeyPairMessage;
import org.cypher.api.GrpcAPI.AssetIssueList;
import org.cypher.api.GrpcAPI.BlockExtention;
import org.cypher.api.GrpcAPI.BlockList;
import org.cypher.api.GrpcAPI.BlockListExtention;
import org.cypher.api.GrpcAPI.BytesMessage;
import org.cypher.api.GrpcAPI.DecryptNotes;
import org.cypher.api.GrpcAPI.DecryptNotesMarked;
import org.cypher.api.GrpcAPI.DecryptNotesTRC20;
import org.cypher.api.GrpcAPI.DelegatedResourceList;
import org.cypher.api.GrpcAPI.DiversifierMessage;
import org.cypher.api.GrpcAPI.EasyTransferResponse;
import org.cypher.api.GrpcAPI.EmptyMessage;
import org.cypher.api.GrpcAPI.ExchangeList;
import org.cypher.api.GrpcAPI.ExpandedSpendingKeyMessage;
import org.cypher.api.GrpcAPI.IncomingViewingKeyDiversifierMessage;
import org.cypher.api.GrpcAPI.IncomingViewingKeyMessage;
import org.cypher.api.GrpcAPI.IvkDecryptAndMarkParameters;
import org.cypher.api.GrpcAPI.IvkDecryptParameters;
import org.cypher.api.GrpcAPI.IvkDecryptTRC20Parameters;
import org.cypher.api.GrpcAPI.NfParameters;
import org.cypher.api.GrpcAPI.NfTRC20Parameters;
import org.cypher.api.GrpcAPI.NodeList;
import org.cypher.api.GrpcAPI.NoteParameters;
import org.cypher.api.GrpcAPI.NullifierResult;
import org.cypher.api.GrpcAPI.OvkDecryptParameters;
import org.cypher.api.GrpcAPI.OvkDecryptTRC20Parameters;
import org.cypher.api.GrpcAPI.PaymentAddressMessage;
import org.cypher.api.GrpcAPI.PrivateParameters;
import org.cypher.api.GrpcAPI.PrivateParametersWithoutAsk;
import org.cypher.api.GrpcAPI.PrivateShieldedTRC20Parameters;
import org.cypher.api.GrpcAPI.PrivateShieldedTRC20ParametersWithoutAsk;
import org.cypher.api.GrpcAPI.ProposalList;
import org.cypher.api.GrpcAPI.Return;
import org.cypher.api.GrpcAPI.ShieldedTRC20Parameters;
import org.cypher.api.GrpcAPI.ShieldedTRC20TriggerContractParameters;
import org.cypher.api.GrpcAPI.SpendAuthSigParameters;
import org.cypher.api.GrpcAPI.SpendResult;
import org.cypher.api.GrpcAPI.TransactionApprovedList;
import org.cypher.api.GrpcAPI.TransactionExtention;
import org.cypher.api.GrpcAPI.TransactionInfoList;
import org.cypher.api.GrpcAPI.TransactionList;
import org.cypher.api.GrpcAPI.TransactionListExtention;
import org.cypher.api.GrpcAPI.TransactionSignWeight;
import org.cypher.api.GrpcAPI.TransactionSignWeight.Result.response_code;
import org.cypher.api.GrpcAPI.ViewingKeyMessage;
...
import org.cypher.common.crypto.sm2.SM2;
import org.cypher.common.utils.Base58;
import org.cypher.common.utils.ByteArray;
import org.cypher.common.utils.TransactionUtils;
...
import org.cypher.core.config.Configuration;
import org.cypher.core.config.Parameter.CommonConstant;
import org.cypher.core.exception.CancelException;
import org.cypher.core.exception.CipherException;
import org.cypher.keystore.CheckStrength;
import org.cypher.keystore.Credentials;
import org.cypher.keystore.Wallet;
import org.cypher.keystore.WalletFile;
import org.cypher.keystore.WalletUtils;
import org.cypher.protos.Protocol.Account;
import org.cypher.protos.Protocol.Block;
import org.cypher.protos.Protocol.ChainParameters;
import org.cypher.protos.Protocol.Exchange;
import org.cypher.protos.Protocol.Key;
import org.cypher.protos.Protocol.MarketOrder;
import org.cypher.protos.Protocol.MarketOrderList;
import org.cypher.protos.Protocol.MarketOrderPairList;
import org.cypher.protos.Protocol.MarketPriceList;
import org.cypher.protos.Protocol.Permission;
...
import org.cypher.protos.Protocol.Transaction.Result;
import org.cypher.protos.Protocol.TransactionInfo;
import org.cypher.protos.Protocol.TransactionSign;
...
import org.cypher.protos.contract.AccountContract.AccountUpdateContract;
import org.cypher.protos.contract.AccountContract.SetAccountIdContract;
...
import org.cypher.protos.contract.ExchangeContract.ExchangeCreateContract;
...
import org.cypher.protos.contract.MarketContract.MarketSellAssetContract;
import org.cypher.protos.contract.ProposalContract.ProposalApproveContract;
import org.cypher.protos.contract.ProposalContract.ProposalCreateContract;
import org.cypher.protos.contract.ProposalContract.ProposalDeleteContract;
import org.cypher.protos.contract.ShieldContract.IncrementalMerkleVoucherInfo;
import org.cypher.protos.contract.ShieldContract.OutputPointInfo;
import org.cypher.protos.contract.ShieldContract.ShieldedTransferContract;
import org.cypher.protos.contract.ShieldContract.SpendDescription;
...
import org.cypher.protos.contract.SmartContractOuterClass.SmartContractDataWrapper;
...
import org.cypher.protos.contract.StorageContract.BuyStorageBytesContract;
import org.cypher.protos.contract.StorageContract.BuyStorageContract;
import org.cypher.protos.contract.StorageContract.SellStorageContract;
...
import org.cypher.protos.contract.WitnessContract.WitnessUpdateContract;
...
public class WalletApi {
  ...
  private Transaction signTransaction(Transaction transaction)
    ...
    while (true) {
      ...
      byte[] passwd = org.cypher.keystore.StringUtils.char2Byte(password);
      org.cypher.keystore.StringUtils.clear(password);
      if (isEckey) {
      ...
      org.cypher.keystore.StringUtils.clear(passwd);
  ...
  public byte[] generateContractAddress(byte[] ownerAddress, Transaction cyp) {
    // get tx hash
    byte[] txRawDataHash = Sha256Sm3Hash.of(cyp.getRawData().toByteArray()).getBytes();
  ...
  public boolean updateSetting(byte[] owner, byte[] contractAddress,
    ...
    if (transactionExtention == null || !transactionExtention.getResult().getResult()) {
      System.out.println("RPC create cyp failed!");
      if (transactionExtention != null) {
  ...
  public boolean triggerContract(
    ...
    if (transactionExtention == null || !transactionExtention.getResult().getResult()) {
      System.out.println("RPC create call cyp failed!");
      System.out.println("Code = " + transactionExtention.getResult().getCode());
      System.out
          .println("Message = " + transactionExtention.getResult().getMessage().toStringUtf8());
      return false;
  ...
  public static boolean sendShieldedCoinWithoutAsk(PrivateParametersWithoutAsk privateParameters,
    ...
    BytesMessage cypHash = rpcCli.getShieldedTransactionHash(transactionExtention.getTransaction());
    if (cypHash == null || cypHash.getValue().toByteArray().length != 32) {
    ...
    for (int i = 0; i < spendDescList.size(); i++) {
      ...
      builder.setTxHash(ByteString.copyFrom(cypHash.getValue().toByteArray()));
